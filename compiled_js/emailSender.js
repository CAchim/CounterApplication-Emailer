...
var fetchReceiversLib = require('./fetchReceivers');
...
var EmailSender = /** @class */ (function () {
    ...
    EmailSender.prototype.sendEmail = function (toParam, subjectParam, textParam, htmlParam) {
        return __awaiter(this, void 0, void 0, function () {
            var EmailBodyText, dbReceivers, receiversFromDB, tmp, index, tmp2, finalReceiver, validEmails;
                ...
                switch (_a.label) {
                    case 0:
                        EmailBodyText = 'In case you view this message you must enable HTML in your emailing software.\nThe following adapter needs your attention, please schedule a maintenance for it ASAP!\n' +
                            textParam;
                        return [4 /*yield*/, fetchReceiversLib.fetchReceivers()];
                    case 1:
                        dbReceivers = _a.sent();
                        receiversFromDB = JSON.stringify(dbReceivers.message);
                        tmp = receiversFromDB.slice(21);
                        index = tmp.indexOf("}") - 1;
